...
The exact collection inventory is **542 HTTP requests and 1,714 explicit `test(...)` assertions**, covering **72/72 OpenAPI operations** and **70/70 protected-operation unauthenticated paths**.
