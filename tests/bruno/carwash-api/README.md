...
- AVAIL-002 shared booking/search decisions, continuous-window slot anchors, complete branch schedule windows and closures, effective offering terms, overlapping configured capacity, same-day branch-isolated queue estimates, optional raw-distance filtering, bounded multi-business responses, and service-read authorization;
