...
- TENANT-001 platform-admin membership onboarding/removal, old-token invalidation, owner/staff tenant scope, foreign-resource safe `404`, tenant enumeration denial, owner second-business denial, global catalogue restriction, discovery-safe DTOs, and unauthenticated coverage for all 71 operations;
