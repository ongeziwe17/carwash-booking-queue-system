...
- Current controller/OpenAPI operation count: **40**
...
|---|---|
| `CUSTOMER` | Own profile, vehicles, bookings, queue-entry reads, and notifications; service-catalogue and availability reads. |
| `STAFF` | Own profile/notifications plus global vehicle, booking, and queue operational access; service-catalogue and availability reads. |
