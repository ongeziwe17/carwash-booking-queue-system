...
public class VehicleController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Invalid identifier", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
            @ApiResponse(responseCode = "401", description = "Authentication required", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
            @ApiResponse(responseCode = "403", description = "Access denied", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
            @ApiResponse(responseCode = "404", description = "Vehicle not found", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
            @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class)))
    })
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "401", description = "Authentication required", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
            @ApiResponse(responseCode = "403", description = "Access denied", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
            @ApiResponse(responseCode = "404", description = "Owner not found", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class))),
    ...
    public Vehicle create(@Valid @RequestBody CreateVehicleRequest req) {
        return service.createVehicle(req.userId(), req.vehicleId(), req.plateNumber(), req.vehicleType(),
                req.brand(), req.model(), req.color(), req.notes());
    }
    ...
    public Vehicle update(
        ...
        return service.updateVehicle(id, request.plateNumber(), request.vehicleType(), request.brand(),
                request.model(), request.color(), request.notes());
    }
