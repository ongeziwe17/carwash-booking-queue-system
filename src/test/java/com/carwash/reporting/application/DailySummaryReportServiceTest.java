...
class DailySummaryReportServiceTest extends ServiceTestSupport {
    ...
    void dailySummaryReturnsZeroTotalsWhenNoDataExists() {
        DailySummaryReportResponse report = reportService.generateDailySummary(TestDates.futureDays(10).toLocalDate(), ensureDefaultBranch(), null);
    ...
    void dailySummaryCountsBookingsForSelectedDateOnly() {
        ...
        DailySummaryReportResponse report = reportService.generateDailySummary(reportDateTime.toLocalDate(), ensureDefaultBranch(), null);
    ...
    void dailySummaryReflectsSynchronizedOperationalLifecycle() {
        ...
        DailySummaryReportResponse before = reportService.generateDailySummary(scheduled.toLocalDate(), ensureDefaultBranch(), null);
